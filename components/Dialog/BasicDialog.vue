...
*/
  ...
  const resolve = () => {
    ...
    const fn = () => (variant.value = 'resolve')
    useTimeoutFn(fn, leaveDuration)
  }

  const reject = () => {
    scrimVariant.value = 'initial'
    const fn = () => (variant.value = 'reject')
    useTimeoutFn(fn, leaveDuration)
  }
    ...
    <dialog ref="dialogEl" :class="baseClass()">
      <slot v-bind="dialog">
        <div :class="headerClass()">
          ...
          <slot name="title" v-bind="{ class: titleClass }">
            <p :class="titleClass()">
              {{ props.title }}
            </p>
          </slot>
        ...
        <div :class="footerClass()">
          <slot
            name="actions"
            v-bind="{ ...dialog, actions, resolve, reject }">
