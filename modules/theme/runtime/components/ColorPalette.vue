...
const contrastHex = (hex: string) =>
  chroma(hex).luminance() > 0.45 ? "#121212" : "#F7F7F7";
</script>

<template>
  <div
    class="relative grid grid-flow-col-dense overflow-hidden rounded-lg h-12"
  >
    <div
      v-for="[tone, color] in Object.entries(tonalPalette)"
