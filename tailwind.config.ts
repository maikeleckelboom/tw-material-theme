...
const tailwindChildSelector = () =>
  plugin(({ matchVariant }) => {
    matchVariant("nth", (v: string) => `& :nth-child(${v})`);
    matchVariant("nth-last", (v: string) => `& :nth-last-child(${v})`);
  });

const tailwindCustomVariants = () =>
  plugin(({ addVariant }) => {
...
const tailwindConfig: Partial<Config> = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        "shadow-xs":
          "0px 1px 2px rgba(0, 0, 0, 0.14), 0px 1px 1px rgba(0, 0, 0, 0.12), 0px 2px 1px rgba(0, 0, 0, 0.2)",
        "shadow-sm":
          "0px 1px 3px rgba(0, 0, 0, 0.12), 0px 1px 2px rgba(0, 0, 0, 0.24)",
        shadow:
          "0px 1px 5px rgba(0, 0, 0, 0.12), 0px 2px 2px rgba(0, 0, 0, 0.08)",
        "shadow-md":
          "0px 4px 6px rgba(0, 0, 0, 0.12), 0px 2px 4px rgba(0, 0, 0, 0.08)",
        "shadow-md-2":
          "0px 4px 6px rgba(0, 0, 0, 0.12), 0px 2px 4px rgba(0, 0, 0, 0.08), 0px 0px 1px rgba(0, 0, 0, 0.08)",
        "shadow-lg":
          "0px 10px 20px rgba(0, 0, 0, 0.12), 0px 3px 5px rgba(0, 0, 0, 0.08)",
        "shadow-xl":
          "0px 15px 30px rgba(0, 0, 0, 0.16), 0px 5px 10px rgba(0, 0, 0, 0.08)",
...
const twTV = withTV(<RequiredConfig & Partial<OptionalConfig>>tailwindConfig);
export const tw = twTV.tw;
